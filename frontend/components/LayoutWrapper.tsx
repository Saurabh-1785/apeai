...
export default function LayoutWrapper({ children }: LayoutWrapperProps) {
  ...
  // If this is the introductory landing page, we want a clean, full-screen canvas
        ...
        <div className="flex-1 md:pl-64 flex flex-col min-h-screen">
          ...
          <header className="h-16 border-b border-slate-200 dark:border-zinc-900 bg-white dark:bg-[#000000] sticky top-0 z-10 flex items-center justify-between px-6 md:px-8 transition-colors">
            ...
            <div className="flex items-center gap-4">
              ...
              <span className="text-xs font-bold text-slate-700 dark:text-zinc-300 hidden sm:inline">Admin Portal</span>
            </div>
          </header>
